...
for class_index, signature_name in enumerate(signature_names):
    ...
    # Load forged images
    for stroke_number in range(1, 21):  
...
for x in range(test_sample_size):
    ...
    if value:
        ...
        # Store filenames
        tested_genuine_filenames.append(pair[0])  
        tested_forged_filenames.append(x_pair_test[x, 1, :, :, 0]) 
...
X_train_svm, X_test_svm, y_train_svm, y_test_svm = train_test_split(
    svm_features, svm_labels, test_size=0.1, random_state=42)
